...
package io.aelf.protobuf.generated.aelf;

public final class Options {
  private Options() {}
  public static void registerAllExtensions(
      com.google.protobuf.ExtensionRegistryLite registry) {
    registry.add(Options.identity);
    registry.add(Options.base);
    registry.add(Options.csharpState);
    registry.add(Options.isView);
    registry.add(Options.isEvent);
    registry.add(Options.isIndexed);
  }
